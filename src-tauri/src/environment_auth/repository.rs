...
pub async fn ensure_row(db: &SqlitePool, environment_id: &str) -> Result<EnvironmentAuth, String> {
...
pub async fn read_by_env_id(
    db: &SqlitePool,
    environment_id: &str,
) -> Result<Option<EnvironmentAuth>, String> {
