...
export const actionFetchEnvironmentsDoc = (state: EnvironmentsStore) =>
	state.fetchEnvironmentsDoc;
export const actionResetEnvironments = (state: EnvironmentsStore) =>
	state.resetEnvironments;
