...
const VarRow: FC<RowProps> = ({ variable, onEdit, onDelete }) => {
	const inferredType = inferVarType(variable.name, variable.value);
	const isSecret = variable.isSecret || inferredType === "secret";
	const type: VarType = isSecret ? "secret" : inferredType;
