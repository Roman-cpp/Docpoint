...
const TOOLS: Tool[] = [
	...
	{
		name: "Generator",
		desc: "Generate strong passwords and UUID identifiers, ready to copy.",
		href: "/generator",
		icon: "✳",
		iconColor: "var(--ink)",
		accent: "var(--purple)",
		...
		<div className={s.overview}>
			<div className={s.content}>
				<header className={s.hero}>
					...
					<p className={s.ovSub}>
						Набор инструментов для работы с API: HTTP-клиент, WebSocket, JSON,
						unix-время и генератор паролей.
					</p>
				</header>
