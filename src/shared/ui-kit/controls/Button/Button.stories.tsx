...
export const WithIcon: Story = {
	args: { variant: "primary", icon: <PlusIcon />, children: "Добавить переменную" },
};
	...
	render: () => (
		<div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
			...
			<div style={{ display: "flex", alignItems: "center", gap: 8 }}>
				...
				<Button variant="ghost" icon={<TrashIcon />}>With icon</Button>
			...
			<div style={{ display: "flex", alignItems: "center", gap: 8 }}>
				...
				<Button variant="subtle" icon={<BoltIcon />}>Fetch token</Button>
			</div>

			{/* Danger */}
			<div style={{ display: "flex", alignItems: "center", gap: 8 }}>
				<Button variant="danger">Danger filled</Button>
				<Button variant="danger" loading>Удаляем…</Button>
				<Button variant="danger-ghost">Danger ghost</Button>
			</div>

			{/* Icon-only */}
			<div style={{ display: "flex", alignItems: "center", gap: 4 }}>
				<Button variant="icon" aria-label="Редактировать"><PencilIcon /></Button>
				<Button variant="icon" aria-label="Удалить"><TrashIcon /></Button>
				<Button variant="icon" aria-label="Добавить"><PlusIcon /></Button>
			</div>
		</div>
	),
};
